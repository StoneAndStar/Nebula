/datum/map/vegas/send_welcome()
	var/obj/effect/overmap/visitable/ship/vegas = SSshuttle.ship_by_type(/obj/effect/overmap/visitable/ship/vegas)

	var/welcome_text = "<center><font size = 3><b>[global.using_map.station_name]</b> Sensor Readings:</font><br>"
	welcome_text += "Report generated on [stationdate2text()] at [stationtime2text()]</center><br /><br />"
	welcome_text += "<hr>Current system:<br /><b>[vegas ? system_name() : "Unknown"]</b><br /><br>"

	if(vegas) //If the overmap is disabled, it's possible for there to be no vegas.
		var/list/space_things = list()
		welcome_text += "Current Coordinates:<br /><b>[vegas.x]:[vegas.y]</b><br /><br>"
		...
		for(var/obj/effect/overmap/visitable/O in space_things)
			...
			if(O.loc != vegas.loc)
				var/bearing = round(90 - Atan2(O.x - vegas.x, O.y - vegas.y),5) //fucking triangles how do they work
				if(bearing < 0)
					bearing += 360
